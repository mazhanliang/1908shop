...
@endif -->
<form  action="{{url('/ku/store')}}" method='post' class="form-horizontal" role="form" enctype='multipart/form-data'>
...
@csrf
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="radio" name='k_is' value='1' checked>库管员
			<input type="radio" name='k_is' value='2'>库主管
		</div>
	</div>
