     ...
     <div class="dingdanlist">
      <table>
       ...
       <tr>
        ...
        <td class="dingimg" width="15%"><img src="{{env('UPLOAD_URL')}}{{$data->goods_img}}" /></td>
        <td width="50%">
         <h3>{{$data->goods_name}}</h3>
         <time>{{$data->goods_desc}}</time>
        </td>
        <td align="right"><input type="text" class="spinnerExample" /></td>
       </tr>
       <tr>
        <th colspan="4"><strong class="orange">¥{{$data->goods_price}}</strong></th>
       </tr>
      </table>
     </div><!--dingdanlist/-->
